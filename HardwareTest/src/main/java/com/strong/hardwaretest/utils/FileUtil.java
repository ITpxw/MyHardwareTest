...
public class FileUtil {
    ...
    public void saveContent(String content) {
        ...
        File reportAddressFile = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/Report");
        reportAddressFile.mkdirs();
        File reportFile = new File(reportAddressFile.getPath(), "/report.txt");
